...
pub const PALETTE_2: [PpuPixel; 16] = [
    // Note that the bytes are reversed from what you would expect
    // The simulator hosts are little endian (or at least the library that provides
    // the from_bytes function is.)
    // Legend of which bits are for which colour: [gggbbbbb, xrrrrrgg]
...
pub const DIGIT_TILES: [[u8; 64]; 10] = [
    ...
    [
        TRANSP_, WHITE__, WHITE__, WHITE__, WHITE__, WHITE__, WHITE__, TRANSP_, WHITE__, TRANSP_,
        TRANSP_, BLACK__, TRANSP_, TRANSP_, WHITE__, TRANSP_, WHITE__, WHITE__, BLACK__, BLACK__,
        TRANSP_, TRANSP_, WHITE__, TRANSP_, TRANSP_, WHITE__, WHITE__, WHITE__, WHITE__, WHITE__,
        BLACK__, TRANSP_, TRANSP_, TRANSP_, TRANSP_, TRANSP_, TRANSP_, BLACK__, WHITE__, TRANSP_,
        TRANSP_, TRANSP_, TRANSP_, TRANSP_, BLACK__, WHITE__, TRANSP_, TRANSP_, TRANSP_, WHITE__,
        WHITE__, WHITE__, WHITE__, WHITE__, TRANSP_, TRANSP_, TRANSP_, TRANSP_, TRANSP_, TRANSP_,
        TRANSP_, TRANSP_, TRANSP_, TRANSP_,
    ],
];
...
pub const TEST_TILEMAP: [u16; 1024] = [
    ...
    0x05, 0x06, 0x07, 0x08, 0x09, 0x05, 0x06, 0x07, 0x08, 0x09, 0x05, 0x06, 0x07, 0x08, 0x09, 0x05,
    0x06, 0x07, 0x08, 0x09, 0x05, 0x06, 0x07, 0x08, 0x09, 0x05, 0x06, 0x07, 0x08, 0x09, 0x05, 0x06,
    // Rows 4-7: Test patterns in 4x4 blocks (using palette 2)
    0x040A, 0x040A, 0x040B, 0x040B, 0x040A, 0x040A, 0x040B, 0x040B, 0x040A, 0x040A, 0x040B, 0x040B,
    0x040A, 0x040A, 0x040B, 0x040B, 0x040A, 0x040A, 0x040B, 0x040B, 0x040A, 0x040A, 0x040B, 0x040B,
    0x040A, 0x040A, 0x040B, 0x040B, 0x040A, 0x040A, 0x040B, 0x040B, 0x040A, 0x040A, 0x040B, 0x040B,
    0x040A, 0x040A, 0x040B, 0x040B, 0x040A, 0x040A, 0x040B, 0x040B, 0x040A, 0x040A, 0x040B, 0x040B,
    0x040A, 0x040A, 0x040B, 0x040B, 0x040A, 0x040A, 0x040B, 0x040B, 0x040A, 0x040A, 0x040B, 0x040B,
    0x040A, 0x040A, 0x040B, 0x040B, 0x040C, 0x040C, 0x040D, 0x040D, 0x040C, 0x040C, 0x040D, 0x040D,
    0x040C, 0x040C, 0x040D, 0x040D, 0x040C, 0x040C, 0x040D, 0x040D, 0x040C, 0x040C, 0x040D, 0x040D,
    0x040C, 0x040C, 0x040D, 0x040D, 0x040C, 0x040C, 0x040D, 0x040D, 0x040C, 0x040C, 0x040D, 0x040D,
    0x040C, 0x040C, 0x040D, 0x040D, 0x040C, 0x040C, 0x040D, 0x040D, 0x040C, 0x040C, 0x040D, 0x040D,
    0x040C, 0x040C, 0x040D, 0x040D, 0x040C, 0x040C, 0x040D, 0x040D, 0x040C, 0x040C, 0x040D, 0x040D,
    0x040C, 0x040C, 0x040D, 0x040D, 0x040C, 0x040C, 0x040D, 0x040D,
