...
\input{chapters/10-reading-instructions}
\input{chapters/11-instruction-summary}
\input{chapters/12-alu-instructions}
\input{chapters/13-memory-instructions}
\input{chapters/14-control-flow}
\input{chapters/15-coprocessor-instructions}
\input{chapters/16-meta-instructions}
