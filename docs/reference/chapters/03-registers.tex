...
(\mnemonic{LDEL}, \mnemonic{LJSR}, and \mnemonic{BRSR}) and the Program Counter pair is incremented after every
instruction.
...
\begin{itemize}
	...
	\item The status register's privileged byte is hidden on reads in protected mode, and cannot be modified directly from
	      protected mode writes.
\end{itemize}
