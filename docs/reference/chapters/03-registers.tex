...
\begin{itemize}
	...
	\item In \textbf{protected mode}:
	      \begin{itemize}
		      ...
		      \item Address-register-pair write-back preserves the high word and updates only the low word
	      \end{itemize}
\end{itemize}
...
\mnemonic{RETS} remain usable in protected mode, but their address-register-pair write-back cannot alter the high word.
