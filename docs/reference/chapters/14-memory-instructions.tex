...
shift result, or auto-update side effect. Memory instructions do not support status update override syntax; the status
...
\begin{table}[H]
	...
	\begin{tabular}{lllllp{5.5cm}}
		...
		\midrule
		LOAD                 & -          & -          & -          & -          & Flags are preserved. \\
		STOR                 & -          & -          & -          & -          & Flags are preserved. \\
		\bottomrule
	\end{tabular}
