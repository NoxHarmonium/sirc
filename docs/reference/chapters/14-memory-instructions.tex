...
\begin{table}[H]
	...
	\begin{tabular}{lp{9cm}}
		...
		Exceptions          & Memory instructions can raise bus, bus-protection, and segment-overflow faults. Processing-unit encodings outside the documented memory forms are reserved or architecturally undefined; they are not required to raise an invalid-opcode fault. \\
...
\end{verbatim}
	...
	\textbf{Exceptions:} May raise bus, bus-protection, or segment-overflow faults.
