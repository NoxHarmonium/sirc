...
The status register contains 5 individual enable bits (bits 9-13 in the privileged byte) that control whether each
hardware interrupt line can trigger an exception:

\begin{itemize}
	\item Bit 9 (E1): Hardware Interrupt Line 1 (Exception Level 5, highest priority)
	\item Bit 10 (E2): Hardware Interrupt Line 2 (Exception Level 4)
	\item Bit 11 (E3): Hardware Interrupt Line 3 (Exception Level 3)
	\item Bit 12 (E4): Hardware Interrupt Line 4 (Exception Level 2)
	\item Bit 13 (E5): Hardware Interrupt Line 5 (Exception Level 1, lowest priority)
\end{itemize}
