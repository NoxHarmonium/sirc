...
\end{verbatim}
	...
	\textbf{Exceptions:} May raise segment-overflow faults when trap-on-address-overflow is enabled. In protected mode,
	raises a privilege-violation fault if write-back would change a written address-register high word.
