...
This is Version 1.0 of the SIRC-1 CPU Reference Manual, issued in draft for internal review and not for external
distribution. Except where an entry explicitly notes otherwise, every instruction, register, and behavior described
here applies to \textit{SIRC-1, all revisions}.
