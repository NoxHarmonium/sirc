...
\textbf{Description:} Puts the CPU into a low-power wait state until an exception occurs. Sets the Waiting for Interrupt bit in the status register. Only valid in supervisor mode.
