...
Unless otherwise noted, control inputs are active low and control outputs are active high. The descriptions below use
"asserted" and "deasserted" to refer to the logical state of a signal according to its signal type.
...
Asserted during the first execution phase of an instruction or exception-unit dispatch. It will be high for phase 1 and
low for every other phase.
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{lX}
		...
		BRW             & Valid whenever BAS is asserted. Low requests a read; high requests a write. Stable until the request completes or aborts.          \\
		...
		SYNC            & Asserted during phase 1 of an instruction or exception-unit dispatch.                                                              \\
		\bottomrule
	\end{tabularx}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{lXXX}
		...
		\midrule
		Read           & A0--A23, BRW=0, BAT, BAS, PROT            & D0--D15 for the selected address        & BACK samples data; BERR/BPER aborts.             \\
		Write          & A0--A23, D0--D15, BRW=1, BAT, BAS, PROT   & No data bus drive                       & BACK accepts write; BERR/BPER aborts.            \\
