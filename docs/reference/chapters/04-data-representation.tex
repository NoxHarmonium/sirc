...
instructions, exception vectors, saved addresses, and any software-defined multi-word integer convention that chooses to
use the architectural order.
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{llX}
		...
		Coprocessor operands & 16 or 8 bits & Coprocessor-defined command or parameter bits \\
		\bottomrule
	\end{tabularx}
...
pre-decrement, or post-increment calculation. If the low word overflows or underflows and \statusbit{TrapOnAddressOverflow}
is set, the instruction raises a segment-overflow fault. If the bit is clear, the low word wraps modulo $2^{16}$.
