...
\begin{table}[H]
	...
	\begin{tabular}{lcccccc}
		...
		\midrule
		\texttt{ADDI r1, \#100}     & 0x00            & 0x1          & 0x0064                & 0b01        & 0x0           & \texttt{0x00420010} \\
		                            & (000000)        & (0001)       & (0000 0000 0110 0100) & (01)        & (0000)        &                     \\
		\midrule
		\texttt{CMPI r2, \#0x8000}  & 0x0A            & 0x2          & 0x8000                & 0b01        & 0x0           & \texttt{0x2A800010} \\
		...
		\midrule
		\texttt{ADDI|== r5, \#42}   & 0x00            & 0x5          & 0x002A                & 0b01        & 0x1           & \texttt{0x014A0011} \\
		                            & (000000)        & (0101)       & (0000 0000 0010 1010) & (01)        & (0001)        &                     \\
		\midrule
		\texttt{SUBI|>= r6, \#10}   & 0x02            & 0x6          & 0x000A                & 0b01        & 0xB           & \texttt{0x0982801B} \\
...
% TODO: Come up with assembler syntax that allows you to override the AF field so you can prevent status register updates
% I'm thinking something like ADDI, r1, #1, s=n to disable status register updates (or s=a for ALU source and s=s for shift source)
...
\begin{table}[H]
	...
	\begin{tabular}{lcccccccccc}
		...
		\midrule
		\texttt{CMPI|NS r1, \#8, RTL r3}   & 0x2A        & 0x1          & 0x08         & 1           & 101         & 0x3         & 0b01        & 0x5           & \texttt{0xA887D15}   \\
		                                   & (101010)    & (0001)       & (00001000)   & (1)         & (101)       & (0011)      & (01)        & (0101)        &                      \\
		\midrule
		\texttt{SHFI r3, \#0, RTR \#5}     & 0x20        & 0x3          & 0x00         & 0           & 110         & 0x5         & 0b10        & 0x0           & \texttt{0x08307520}  \\
		                                   & (100000)    & (0011)       & (00000000)   & (0)         & (110)       & (0101)      & (10)        & (0000)        &                      \\
		\bottomrule
	\end{tabular}
...
\begin{itemize}
	...
	\item AF field for ALU: 00=no update, 01=update from ALU, 10=update from shift (see SHFI row 7)
	\item Condition code examples: 0x0 = Always, 0x2 = Not Equal (!=), 0x5 = Negative (<0)
	\item SHFI is a meta instruction using ADDI opcode (0x20) with AF=0b10
\end{itemize}
...
\begin{table}[H]
	...
	\begin{tabular}{lccccccccccc}
		...
		\midrule
		\texttt{XORR r2, r3, r4, RTR \#1}   & 0x36        & 0x2         & 0x3         & 0x4         & 0           & 110         & 0x1         & 0b01        & 0x0           & \texttt{0x0DA346D10} \\
		...
		\midrule
		\texttt{SHFR r1, r0, r2, ASL \#3}   & 0x30        & 0x1         & 0x0         & 0x2         & 0           & 011         & 0x3         & 0b10        & 0x0           & \texttt{0x0C102720}  \\
		                                    & (110000)    & (0001)      & (0000)      & (0010)      & (0)         & (011)       & (0011)      & (10)        & (0000)        &                      \\
		\bottomrule
	\end{tabular}
...
\begin{itemize}
	...
	\item SHFR is a meta instruction using ADDR opcode (0x30) with AF=0b10
\end{itemize}
