...
\begin{description}
	...
	\item[Additional Flags (2 bits)] Used in memory operations to specify address register pairs (a, p, s, l) and in ALU operations to specify how the status register is updated.
...
STOR (r2, s)+, r1       ; memory[s + r2] = r1; s = s + 1
\end{lstlisting}

\section{Shift Encoding}
