...
\begin{itemize}
	...
	\item \textbf{Bus Protection Fault:} Raised when an external device asserts the bus protection error CPU pin.
	...
	\item \textbf{Double Fault:} Raised when a fault occurs while another fault is already being handled
	      ...
	      The CPU jumps to vector 0x08 (the double fault vector). This is typically used as a last-chance handler to dump
