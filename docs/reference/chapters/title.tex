...
This reference manual provides comprehensive documentation for the SIRC-1 CPU architecture and the SIRCIS (SIRC
Instruction Set) instruction set. It is intended for:
