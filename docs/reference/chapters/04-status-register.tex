...
\begin{description}
	...
	\item[Note:] This bit provides basic memory protection by preventing user code from changing memory segments. With the
	      exception of writing to the status register, preforming a restricted operation will cause a "privilege violation"
	      fault.
\end{description}
...
\begin{itemize}
	\item \textbf{E1 (Bit 9):} Enable Hardware Interrupt Line 1 (Level 5, highest priority)
	\item \textbf{E2 (Bit 10):} Enable Hardware Interrupt Line 2 (Level 4)
	\item \textbf{E3 (Bit 11):} Enable Hardware Interrupt Line 3 (Level 3)
	\item \textbf{E4 (Bit 12):} Enable Hardware Interrupt Line 4 (Level 2)
\end{itemize}

\textbf{Note:} Hardware Interrupt Line 5 (Level 1) is a Non-Maskable Interrupt (NMI) and is always enabled. It cannot
