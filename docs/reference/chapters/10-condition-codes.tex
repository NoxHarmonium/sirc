...
LOAD|LO r3, r2           ; r3 = b if a <= b
	\end{lstlisting}
	\caption{Conditional Assignment}
\end{example}
...
LJSR|>> a                ; Call function if r1 > 0 (signed)
	\end{lstlisting}
	\caption{Conditional Function Call}
\end{example}
