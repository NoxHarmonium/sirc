...
adding execution phases. DMA meta-instructions are the main exception: after the normal coprocessor dispatch they hold
instruction fetch until the DMA unit has completed its bus transfers. This fixed execution sequence greatly simplifies
software development and hardware design. See Chapter~\ref{ch:cpu-architecture} for the bus signal timing, wait-state,
and response-priority rules.
