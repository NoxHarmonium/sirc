...
All SIRCIS instructions execute in exactly 6 clock cycles, following the six-stage execution phase model. This fixed
...
\subsection{No Execution Phase Stalls}
