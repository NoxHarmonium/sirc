...
\begin{lstlisting}
CMPR r1, r2                   ; 6 cycles
ADDR|> r3, r4, r5             ; 6 cycles (exec if r1 > r2)
ADDR|<= r3, r6, r7            ; 6 cycles (exec if r1 <= r2)
...
The SIRCULAR does not implement pipelining in the traditional sense where multiple instructions are in flight simultaneously. Instead:
...
; Use:
CMPR r1, r2
ADDI|> r3, #1              ; Saves branch overhead
    \end{lstlisting}
...
\midrule
SIRCULAR & 6.0 & Fixed, all instructions \\
...
The SIRCULAR's fixed 6-cycle execution makes it slower than pipelined RISC CPUs but more predictable. It's comparable to early microprocessors while being simpler to implement in hardware.
