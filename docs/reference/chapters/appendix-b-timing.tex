...
adding execution phases. This fixed execution sequence greatly simplifies software development and hardware design. See
Chapter~\ref{ch:cpu-architecture} for the bus signal timing, wait-state, and response-priority rules.
