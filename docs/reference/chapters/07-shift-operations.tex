...
ADDI r1, #0, ROL #1  ; Shift high word, carry -> bit 0
\end{lstlisting}
...
LOAD r3, #1               ; r3 = 1
ADDR r3, r3, #0, LSL r2   ; r3 = (r3 << r2) = 1 << N
ORRR r1, r3               ; r1 |= (1 << N)
...
ADDI r1, #0, ROL #1   ; Rotate high with carry
\end{lstlisting}
...
ADDI r2, #0, ROR #1   ; Rotate low with carry
\end{lstlisting}
