...
Probably performs addition but discards the result, only updating flags. Similar to \mnemonic{CMP} but using ADD semantics instead of SUB.
...
This means the instructions \textit{will} work, but their exact behavior depends on the hardware implementation details.
