...
\subsection{Hardware Interrupt Enable Bits (E1--E5) -- Bits 9--13}

These five bits individually control whether each of the five hardware interrupt lines is enabled:
...
\begin{itemize}
	...
	\item \textbf{E5 (Bit 13):} Enable Hardware Interrupt Line 5 (Level 1, lowest priority)
\end{itemize}
...
; Enable all hardware interrupts (set bits 9-13)
ORRI sr, #0x3E00

; Disable all hardware interrupts (clear bits 9-13)
ANDI sr, #0xC1FF
