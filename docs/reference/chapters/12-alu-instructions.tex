...
\begin{table}[H]
	...
	\begin{tabular}{lllll}
		\toprule
		\textbf{Family} & \textbf{Immediate} & \textbf{Short Immediate} & \textbf{Register} & \textbf{Writes Result} \\
		\midrule
		ADD             & \texttt{ADDI rD, \#imm16} & \texttt{ADDI rD, \#imm8, shift} & \texttt{ADDR rD, rS1, rS2[, shift]} & Yes \\
		ADC             & \texttt{ADCI rD, \#imm16} & \texttt{ADCI rD, \#imm8, shift} & \texttt{ADCR rD, rS1, rS2[, shift]} & Yes \\
		SUB             & \texttt{SUBI rD, \#imm16} & \texttt{SUBI rD, \#imm8, shift} & \texttt{SUBR rD, rS1, rS2[, shift]} & Yes \\
		SBC             & \texttt{SBCI rD, \#imm16} & \texttt{SBCI rD, \#imm8, shift} & \texttt{SBCR rD, rS1, rS2[, shift]} & Yes \\
		AND             & \texttt{ANDI rD, \#imm16} & \texttt{ANDI rD, \#imm8, shift} & \texttt{ANDR rD, rS1, rS2[, shift]} & Yes \\
		ORR             & \texttt{ORRI rD, \#imm16} & \texttt{ORRI rD, \#imm8, shift} & \texttt{ORRR rD, rS1, rS2[, shift]} & Yes \\
		XOR             & \texttt{XORI rD, \#imm16} & \texttt{XORI rD, \#imm8, shift} & \texttt{XORR rD, rS1, rS2[, shift]} & Yes \\
		CMP             & \texttt{CMPI rS, \#imm16} & \texttt{CMPI rS, \#imm8, shift} & \texttt{CMPR rS1, rS2[, shift]}      & No  \\
		TSA             & \texttt{TSAI rS, \#imm16} & \texttt{TSAI rS, \#imm8, shift} & \texttt{TSAR rS1, rS2[, shift]}      & No  \\
		TSX             & \texttt{TSXI rS, \#imm16} & \texttt{TSXI rS, \#imm8, shift} & \texttt{TSXR rS1, rS2[, shift]}      & No  \\
		\bottomrule
	\end{tabular}
