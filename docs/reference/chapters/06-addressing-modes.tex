...
The SIRC-1 CPU supports eight addressing modes that specify how operands are accessed. These modes determine whether an
...
\begin{table}[H]
	...
	\begin{tabular}{lp{8cm}}
		...
		Implied            & No operand specified (inferred by the assembler)        \\
...
signed or unsigned value. For short immediate mode, it is an 8-bit value that allows for the instruction source to be shifted.
