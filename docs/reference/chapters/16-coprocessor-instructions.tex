...
assemblers emit canonical values and coprocessors must not interpret them as destination-register writes. Opcode 0x2F is
an encoding-level short-immediate COPI form, but this assembler revision does not expose public syntax for it.
...
\begin{instructionbox}{COPI/COPR -- Coprocessor Call}
	\textbf{Opcodes:} 0x0F (Immediate), 0x3F (Register). Opcode 0x2F is reserved for an encoding-level short-immediate form.
