...
\mnemonic{LOAD} (\opcode{07}, \opcode{37}) only when the default \texttt{[N]} AF encoding is used; an explicit AF
suffix on \mnemonic{LOAD} leaves all four flags architecturally undefined. See Chapter~\ref{ch:alu-instructions} for
details.
