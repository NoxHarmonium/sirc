...
Several commonly-used operations are implemented as meta-instructions (pseudo-instructions) that assemble to specific
opcodes:
...
\begin{table}[H]
	...
	\begin{tabular}{llp{7cm}}
		...
		\mnemonic{WAIT}           & \texttt{COPI r1, \#0x1900} & Wait for interrupt     \\
