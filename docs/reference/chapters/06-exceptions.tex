...
\begin{figure}[H]
	...
	\begin{bytefield}[bitwidth=1.5em]{16}
		...
		\bitbox{3}{BAT} & \bitbox{1}{D} & \bitbox{4}{Current Fault} & \bitbox{4}{Original Fault} &
		\bitbox{4}{Reserved}
	\end{bytefield}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{1.2cm}>{\raggedright\arraybackslash}p{1.5cm}>{\raggedright\arraybackslash}p{1.1cm}>{\raggedright\arraybackslash}p{1.9cm}>{\raggedright\arraybackslash}p{1.7cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}p{1.5cm}>{\raggedright\arraybackslash}p{1.2cm}}
		...
		0x03            & 0x0006--0x0007   & 7                 & Segment overflow & \mbox{SR.A gated}    & Faulting instruction    & Fault metadata    & Yes             \\
		...
		0x06            & 0x000C--0x000D   & 7                 & Trace fault      & \mbox{SR.T gated}    & Next instruction        & Fault metadata    & Yes             \\
		...
		0x20            & 0x0040--0x0041   & 5                 & Level 4 hardware & \mbox{SR.E4}         & Next instruction        & Link register 4   & Yes             \\
		0x30            & 0x0060--0x0061   & 4                 & Level 3 hardware & \mbox{SR.E3}         & Next instruction        & Link register 3   & Yes             \\
		0x40            & 0x0080--0x0081   & 3                 & Level 2 hardware & \mbox{SR.E2}         & Next instruction        & Link register 2   & Yes             \\
		0x50            & 0x00A0--0x00A1   & 2                 & Level 1 hardware & \mbox{SR.E1}         & Next instruction        & Link register 1   & Yes             \\
