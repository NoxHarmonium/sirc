...
double-fault vector fetch fails, the CPU keeps attempting to dispatch the double fault.
...
If a bus or protection fault occurs during the reset-vector fetch, the CPU remains in a reset-failed state and does not
execute program instructions. External hardware should assert \texttt{RSTI} again after making the reset vector
available.
